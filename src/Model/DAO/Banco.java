...
public class Banco {
    ...
    public static void inicia(){
        ...
        Servico servico1 = new Servico(1, "Corte Simples", 18.0);
        Servico servico2 = new Servico(2, "Corte Degrade", 30.0);
        Servico servico3 = new Servico(3, "Barba Simples", 15.0);
        Servico servico4 = new Servico(4, "Barba Desenhada", 25.0);
        Servico servico5 = new Servico(5, "Sombrancelhas", 10.0);
        Servico servico6 = new Servico(6, "Penteados", 3.0);

        Agendamento agendamento1 = new Agendamento(1, cliente1, servico2, 30.0, "14/07/2018 09:30");
        Agendamento agendamento2 = new Agendamento(2, cliente3, servico4, 40.0, "14/07/2018 10:00");
        Agendamento agendamento3 = new Agendamento(3, cliente4, servico1, 18.0, "14/07/2018 10:30");
